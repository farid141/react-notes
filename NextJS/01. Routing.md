...
Dalam NextJS, routing dilakukan dengan file-based. Sehingga tidak perlu menuliskan konfigurasi routing di sebuah file. Terdapat 2 cara yaitu `app router` dan `page router`. App router adalah versi terkini yang lebih powerfull dan efisien daripada page router:

- Secara default SSR
- Auto layout from parent
